...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_description_SOURCE_PREFIX /root/tare_planner/src/autonomous_exploration_development_environment/src/velodyne_simulator/velodyne_description)
  set(velodyne_description_DEVEL_PREFIX /root/tare_planner/devel)
  ...
  set(velodyne_description_INSTALL_PREFIX /root/tare_planner/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tare_planner/src/autonomous_exploration_development_environment/src/velodyne_simulator/velodyne_description/${idir}'.  ${_report}")
    endif()
